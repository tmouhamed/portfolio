                ...
                return (
                  <div className="main__content-block__col" key={uuidv4()}>
                    <div className="main__content-block__card">
                      ...
                      {project.link ? <div className="main__content-block__card-subContent">
                        <a className="main__content-block__card-link" href={project.link} rel="noopener noreferrer" target="_blank"><img src={Link} alt="link" /> </a>
                        <ul className="main__content-block__card-list">
                          {project.usedLang.map(item => {
